"""NOTE: for conversion from JSON files to one COCO JSON file was used script from https://github.com/Tony607/labelme2coco/blob/master/labelme2coco.py
Link for public blog for this work: https://www.dlology.com/blog/how-to-create-custom-coco-data-set-for-instance-segmentation/"""
